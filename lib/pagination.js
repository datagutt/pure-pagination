(function(module) {
	...
	ItemPaginator.prototype.render = function() {
		...
		var html = '<ul class="pure-paginator">';
		...
		if(result.first) {
			html += '<li><a href="' + prelink + result.first + '" class="pure-button first">' + this.options.translator('FIRST') + '</a></li>';
		} else {
			html += '<span class="paginator-first">' + this.options.translator('FIRST') + '</span>';
		}

		if(result.previous) {
			html += '<li><a href="' + prelink + result.previous + '" class="pure-button prev">' + this.options.translator('PREVIOUS') + '</a></li>';
		} else {
			html += '<span class="paginator-previous">' + this.options.translator('PREVIOUS') + '</span>';
		}

		if(result.next) {
			html += '<li><a href="' + prelink + result.next + '" class="pure-button next">' + this.options.translator('NEXT') + '</a></li>';
		} else {
			html += '<span class="paginator-next">' + this.options.translator('NEXT') + '</span>';
		}

		if(result.last) {
			html += '<li><a href="' + prelink + result.last + '" class="pure-button last">' + this.options.translator('LAST') + '</a></li>';
		} else {
